...
class HistogramBase {
public:
    using entry_t = std::pair<sym_t, size_t>;
...
public:
    ...
    inline HistogramBase(HistogramBase<sym_t>&& other) : m_entries(other.m_entries) {
    }

    inline HistogramBase(const HistogramBase<sym_t>& other) : m_entries(other.m_entries) {
    }

    inline ~HistogramBase() {
    }

    inline HistogramBase& operator=(HistogramBase<sym_t>&& other) {
        m_entries = std::move(other.m_entries);
        return *this;
    }

    inline HistogramBase& operator=(const HistogramBase<sym_t>& other) {
...
inline std::ostream& operator << (
    std::ostream& os, const typename HistogramBase<sym_t>::entry_t& p) {
